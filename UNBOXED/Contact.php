...
if ($_SERVER["REQUEST_METHOD"] == "POST") {
    ...
    $sql = "INSERT INTO message (email, name, contact_number, message) VALUES ('$email', '$fullname', '$phone', '$message')";
  ...
  <a href="javascript:history.go(-1);"><i class="bi bi-chevron-left"></i></a>
    <div class="row justify-content-md-center">
      <div class="col-12 col-md-10 col-lg-8 col-xl-7 col-xxl-6">
        <h2 class="mb-4 display-5 text-center"style="color: white">Contact</h2>
