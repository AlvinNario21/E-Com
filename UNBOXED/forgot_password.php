...
if ($_SERVER["REQUEST_METHOD"] == "POST") {
    ...
    if ($result->num_rows > 0) {
        // User exists in the customer table, proceed to the next modal for password reset
        echo '<script>window.location.href = "reset_password.php?email='.$email.'&user_type=customer";</script>';
    } else {
        ...
        if ($result->num_rows > 0) {
            // User exists in the driver table, proceed to the next modal for password reset
            echo '<script>window.location.href = "reset_password.php?email='.$email.'&user_type=driver";</script>';
        } else {
